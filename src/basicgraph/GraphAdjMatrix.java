...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getNeighbors(int v) {
		...
		for (int i = 0; i < getNumVertices(); i ++) {
			//takes into account several edges, think real world data, for example,
			//think about getting to an intersection via two different streets
			//on a city road map
			//so we count the number of times we can get to a neighbor
			//normally [v][i] would be either 0 or 1, but with multiple edges,
			//we need this for loop to keep adding to neighbors
