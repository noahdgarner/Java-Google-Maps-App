...
public class GraphAdjList extends Graph {
	...
	//hashmap linking integers to list of integers
	//note however, that in Week 3 we will be creating a class called
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 for (int u : oneHop) {
		 	//add all appends to our existing list. Don't ask questions
			 //it is super inefficient
		 	twoHop.addAll(adjListsMap.get(u));
		 }
